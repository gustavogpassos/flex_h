...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="lib/sources/datatables/jquery.dataTables.min.css"/>
    <link rel="stylesheet" type="text/css" href="lib/sources/datatables/responsive.dataTables.min.css"/>
    ...
    <script type="text/javascript" src="lib/sources/datatables/dataTables.responsive.min.js"></script>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="navbar-nav mr-auto">
                ...
                <?php if($_SESSION['tp_usuario']=='loja'){ ?>
                <li class="nav-item">
...
<div class="container">
    ...
    <div class="row">
        ...
        <span class="label label-default">@Departamento TI - Lojas Volpato :: 2018</span>
    </div>
